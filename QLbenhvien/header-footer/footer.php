            <div class="row">
              <div class="col-lg-4">
                  ...
                  <div class="card-body" style="height: 340px;">
                    <li>Giáo Viên hướng dẫn: <span style="font-weight: bold;"> Nguyễn Văn A</span>
                    </li><!-- 
                <span style="font-weight: bold; margin-left: 12.5px;">Nguyễn Văn B</span>
                    </li> -->
                    <p>--------------------------------------------------------</p>
                    ...
                    <div style="width: 65%; float: left; font-weight: bold ">
                      <p>Trần Minh Thiện</p>
